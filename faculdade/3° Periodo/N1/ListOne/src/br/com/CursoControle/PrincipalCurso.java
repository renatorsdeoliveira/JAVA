...
import br.com.CursoModelo.CursoDoutordo;
...
public class PrincipalCurso {
	...
	private static void mostraCursoDoutorado() {
		CursoDoutordo cd = new CursoDoutordo();
		
		cd.setCodigo(Integer.parseInt(JOptionPane.showInputDialog("Digite o codído do Curso: ")));
