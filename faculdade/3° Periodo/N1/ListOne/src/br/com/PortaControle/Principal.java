...
import br.com.PortaModelo.Pais;
...
public class Principal {
	...
	public static void main(String[] args) {
		...
		int opc  = Integer.parseInt(JOptionPane.showInputDialog( "Digite a opção\n"
				 +"1 - Imprimir\n"
		...
		case 2:
			...
			if(pais.equals(paises.contains(pais)))
				JOptionPane.showMessageDialog(null, "Não Existem paises repitidos");
