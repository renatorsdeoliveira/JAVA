...
import br.com.EX_04.Dado;
import br.com.EX_04.Pessoa;
...
public class Confronto {
	...
	public static void main(String[] args) {
		...
		ListaDado.add(d1);
		 ...
		 Data dt = new Data();
		 JOptionPane.showMessageDialog(null, "ENTRO COM AS INFORMAÇÕES DO jOGO");
		 dt.setDia(Integer.parseInt(JOptionPane.showInputDialog("Digite o Dia do Confronto: ")));
		 dt.setMes(Integer.parseInt(JOptionPane.showInputDialog("Digite o Mês do Confronto: ")));
		 Endereco ed = new Endereco();
		 JOptionPane.showMessageDialog(null,"CADATRE O ENDEREÇO CO CONFRONTO ");
		 ...
		 ps.setNome(JOptionPane.showInputDialog("Digite o nome do 1º Participante: "));
		 pss.setNome(JOptionPane.showInputDialog("Digite o nome do 2º Partipante: "));
		 JOptionPane.showMessageDialog(null, "PRIMEIRO CONFRONTO\n"+ps.getNome()+" VS "+pss.getNome());
		 
		 ps3.setNome(JOptionPane.showInputDialog("Digite o nome do 3º Participante: "));
		 ps4.setNome(JOptionPane.showInputDialog("Digite o nome do 4º Partipante: "));
		 JOptionPane.showMessageDialog(null, "SEGUNDO CONFRONTO\n"+ps3.getNome()+" VS "+ps4.getNome());
		 
		 ps5.setNome(JOptionPane.showInputDialog("Digite o nome do 5º Participante: "));
		 ps6.setNome(JOptionPane.showInputDialog("Digite o nome do 6º Partipante: "));
		 JOptionPane.showMessageDialog(null, "TERCEIRO CONFRONTO\n"+ps5.getNome()+" VS "+ps6.getNome());
		 JOptionPane.showMessageDialog(null, "REGRAS\n\nCada um terá dois dados o primeiro de [6] e o  segundo de [8]\n\nBoa Sorte!");
