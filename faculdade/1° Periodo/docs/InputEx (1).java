...
public class InputEx {
	...
	public static void main(String[] args) {
		...
		do {
			...
			if (MA < 0 || MA > 10)
				System.out.println("Média de Atividades inválida, tente novamente.");
		} while (MA < 0 || MA > 10);
		...
		System.out.printf("\nO aluno de identificação %d"+ 
				" obteve média %.2f por isso seu conceito foi: %c", nIdent, media, conceito);
